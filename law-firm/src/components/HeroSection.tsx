  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-24 pb-12 overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        {/* Ganesh Background Logo — the main centerpiece */}
        <div className="absolute inset-0 flex items-center justify-center">
          {/* Outermost ambient glow disc */}
          <motion.div
          ...
          {/* Outermost slow-rotate dashed ring */}
          <motion.div
            className="absolute rounded-full"
          ...
          {/* Second ring — counter rotate with tick marks */}
          <motion.div
            className="absolute rounded-full"
          ...
          {/* Third inner ring — slow pulse */}
          <motion.div
            className="absolute rounded-full"
            style={{
              width: 460, height: 460,
              border: "1.5px solid rgba(201,168,76,0.22)",
              boxShadow: "0 0 80px 6px rgba(201,168,76,0.08), inset 0 0 80px 6px rgba(201,168,76,0.04)",
            }}
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: "0 0 40px 8px rgba(201,168,76,0.06)",
            }}
            animate={{ rotate: 360 }}
            transition={{ duration: 120, repeat: Infinity, ease: "linear" }}
          />

          {/* The Ganesh Image — large, centered, golden, glowing */}
          <motion.div
          ...
          >
            <motion.img
              ...
              style={{
                filter: "sepia(1) saturate(5) hue-rotate(5deg) brightness(0.85) drop-shadow(0 0 30px rgba(201,168,76,0.5)) drop-shadow(0 0 60px rgba(201,168,76,0.25))",
                opacity: 0.18,
              }}
          ...
          {/* 4 corner accent dots at 45-degree positions */}
          {[0, 90, 180, 270].map((deg) => (
            <motion.div
              ...
              style={{
                width: 6, height: 6,
                background: "#C9A84C",
                boxShadow: "0 0 10px 3px rgba(201,168,76,0.6)",
                top: "50%", left: "50%",
                transformOrigin: "0 0",
                transform: `rotate(${deg}deg) translateX(228px) translate(-50%, -50%)`,
              }}
      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col items-center">
        ...
        {/* Scroll indicator — subtle pulse only, no text */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
